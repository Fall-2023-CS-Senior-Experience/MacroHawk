  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final workoutOptionsWorkoutsResponse = snapshot.data!;
                                  ...
                                  Expanded(
                                    child: Theme(
                                      ...
                                      child: CheckboxListTile(
                                        ...
                                        title: Text(
                                          (WorkoutsCall.musclename(
                                            workoutOptionsWorkoutsResponse
                                                .jsonBody,
                                          ) as List)
