...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'CardiWorkout1',
          path: '/cardiWorkout1',
          builder: (context, params) => CardiWorkout1Widget(),
        ),
        FFRoute(
          name: 'CardioBlastBegin',
          path: '/cardioBlastBegin',
          builder: (context, params) => CardioBlastBeginWidget(),
        ),
        FFRoute(
          name: 'FoodApiResults',
          path: '/foodApiResults',
          builder: (context, params) => FoodApiResultsWidget(
