...
import 'muscle_group_a_p_i_model.dart';
export 'muscle_group_a_p_i_model.dart';

class MuscleGroupAPIWidget extends StatefulWidget {
  const MuscleGroupAPIWidget({
    Key? key,
  ...
  @override
  _MuscleGroupAPIWidgetState createState() => _MuscleGroupAPIWidgetState();
}

class _MuscleGroupAPIWidgetState extends State<MuscleGroupAPIWidget> {
  late MuscleGroupAPIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MuscleGroupAPIModel());
