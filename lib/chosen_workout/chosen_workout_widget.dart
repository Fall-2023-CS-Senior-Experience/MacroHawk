...
import 'chosen_workout_model.dart';
export 'chosen_workout_model.dart';

class ChosenWorkoutWidget extends StatefulWidget {
  const ChosenWorkoutWidget({Key? key}) : super(key: key);

  @override
  _ChosenWorkoutWidgetState createState() => _ChosenWorkoutWidgetState();
}

class _ChosenWorkoutWidgetState extends State<ChosenWorkoutWidget> {
  late ChosenWorkoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChosenWorkoutModel());
  }
