...
class _BreakfastWidgetState extends State<BreakfastWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.tab == 0) {
        _model.breakfastlist = await queryNutritionsRecordOnce(
        ...
        setState(() {
          _model.snackListname =
              _model.breakfastlist!.toList().cast<NutritionsRecord>();
        });
      } else {
        if (widget.tab == 1) {
          _model.breakfastlistW = await queryNutritionsRecordOnce(
            parent: FFAppState().userIdRef,
            queryBuilder: (nutritionsRecord) => nutritionsRecord
                .where(
                  'mealtime',
          ...
          setState(() {
            _model.snackListname =
                _model.breakfastlistW!.toList().cast<NutritionsRecord>();
          });
        } else {
          _model.breakfastlistM = await queryNutritionsRecordOnce(
            parent: FFAppState().userIdRef,
            queryBuilder: (nutritionsRecord) => nutritionsRecord
                .where(
                  'mealtime',
          ...
          setState(() {
            _model.snackListname =
                _model.breakfastlistM!.toList().cast<NutritionsRecord>();
          });
        }
      }
    });
