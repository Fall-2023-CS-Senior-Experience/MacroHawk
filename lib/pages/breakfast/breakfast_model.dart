...
class BreakfastModel extends FlutterFlowModel<BreakfastWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in Breakfast widget.
  List<NutritionsRecord>? breakfastlist;
  // Stores action output result for [Firestore Query - Query a collection] action in Breakfast widget.
  List<NutritionsRecord>? breakfastlistW;
  // Stores action output result for [Firestore Query - Query a collection] action in Breakfast widget.
  List<NutritionsRecord>? breakfastlistM;
